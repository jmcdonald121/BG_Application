VERSION 5.00
Begin VB.Form frmSdeParameters 
   Caption         =   "SDE Connection Parameters"
   ClientHeight    =   4635
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frmSdeParameters"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'------------------------------------------------------------------------------
'Title: frmSdeParameters.frm
'Date: 20051219
'Version: 1.0
'Abstract:  This form loads the SDE connection parameters into the registry
...
Const c_sModuleFileName As String = "frmSdeParameters.frm"
...
'Save the data into the registry
    ...
    SaveSetting "ArcView", "ODNR_Geology", "SDEServer", txtSdeServer.Text
    SaveSetting "ArcView", "ODNR_Geology", "SDEDatabase", txtSdeDatabaseName.Text
    SaveSetting "ArcView", "ODNR_Geology", "SDEUser", txtSdeUserName.Text
    SaveSetting "ArcView", "ODNR_Geology", "SDEInstance", txtSdeInstance.Text
    SaveSetting "ArcView", "ODNR_Geology", "SDEPassword", txtSdePassword.Text
    SaveSetting "ArcView", "ODNR_Geology", "SDEVersion", txtSdeVersion.Text
    cmdCancel_Click
...
'Activate form and load the saved information into the appropriate text boxes
    ...
    txtSdeServer.Text = GetSetting("ArcView", "ODNR_Geology", "SDEServer")
    txtSdeDatabaseName.Text = GetSetting("ArcView", "ODNR_Geology", "SDEDatabase")
    txtSdeUserName.Text = GetSetting("ArcView", "ODNR_Geology", "SDEUser")
    txtSdeInstance.Text = GetSetting("ArcView", "ODNR_Geology", "SDEInstance")
    txtSdePassword.Text = GetSetting("ArcView", "ODNR_Geology", "SDEPassword")
    txtSdeVersion.Text = GetSetting("ArcView", "ODNR_Geology", "SDEVersion")
