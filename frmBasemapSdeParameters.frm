VERSION 5.00
Begin VB.Form frmBasemapSdeParameters 
   Caption         =   "Basemap SDE Connection Parameters"
   ClientHeight    =   4635
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frmBasemapSdeParameters"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'------------------------------------------------------------------------------
'Title: frmBasemapSdeParameters.frm
'Date: 20051219
'Version: 1.0
'Abstract:  This form loads the Basemap SDE connection parameters into the registry
...
Const c_sModuleFileName As String = "frmBasemapSdeParameters.frm"
...
'Save the data into the registry
    ...
    SaveSetting "ArcView", "ODNR_Geology", "BasemapSDEServer", txtSdeServer.Text
    SaveSetting "ArcView", "ODNR_Geology", "BasemapSDEDatabase", txtSdeDatabaseName.Text
    SaveSetting "ArcView", "ODNR_Geology", "BasemapSDEUser", txtSdeUserName.Text
    SaveSetting "ArcView", "ODNR_Geology", "BasemapSDEInstance", txtSdeInstance.Text
    SaveSetting "ArcView", "ODNR_Geology", "BasemapSDEPassword", txtSdePassword.Text
    SaveSetting "ArcView", "ODNR_Geology", "BasemapSDEVersion", txtSdeVersion.Text
    cmdCancel_Click
...
'Activate form and load the saved information into the appropriate text boxes
    ...
    txtSdeServer.Text = GetSetting("ArcView", "ODNR_Geology", "BasemapSDEServer")
    txtSdeDatabaseName.Text = GetSetting("ArcView", "ODNR_Geology", "BasemapSDEDatabase")
    txtSdeUserName.Text = GetSetting("ArcView", "ODNR_Geology", "BasemapSDEUser")
    txtSdeInstance.Text = GetSetting("ArcView", "ODNR_Geology", "BasemapSDEInstance")
    txtSdePassword.Text = GetSetting("ArcView", "ODNR_Geology", "BasemapSDEPassword")
    txtSdeVersion.Text = GetSetting("ArcView", "ODNR_Geology", "BasemapSDEVersion")
