VERSION 5.00
Begin VB.Form frmAUMSdeParameters 
   Caption         =   "AUM SDE Connection Parameters"
   ClientHeight    =   4635
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frmAUMSdeParameters"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'------------------------------------------------------------------------------
'Title: frmAUMSdeParameters.frm
'Date: 20051219
'Version: 1.0
'Abstract:  This form loads the AUM SDE connection parameters into the registry
...
Const c_sModuleFileName As String = "frmAUMSdeParameters.frm"
...
'Save the data into the registry
    ...
    SaveSetting "ArcView", "ODNR_Geology", "AUMSDEServer", txtSdeServer.Text
    SaveSetting "ArcView", "ODNR_Geology", "AUMSDEDatabase", txtSdeDatabaseName.Text
    SaveSetting "ArcView", "ODNR_Geology", "AUMSDEUser", txtSdeUserName.Text
    SaveSetting "ArcView", "ODNR_Geology", "AUMSDEInstance", txtSdeInstance.Text
    SaveSetting "ArcView", "ODNR_Geology", "AUMSDEPassword", txtSdePassword.Text
    SaveSetting "ArcView", "ODNR_Geology", "AUMSDEVersion", txtSdeVersion.Text
    cmdCancel_Click
...
'Activate form and load the saved information into the appropriate text boxes
    ...
    txtSdeServer.Text = GetSetting("ArcView", "ODNR_Geology", "AUMSDEServer")
    txtSdeDatabaseName.Text = GetSetting("ArcView", "ODNR_Geology", "AUMSDEDatabase")
    txtSdeUserName.Text = GetSetting("ArcView", "ODNR_Geology", "AUMSDEUser")
    txtSdeInstance.Text = GetSetting("ArcView", "ODNR_Geology", "AUMSDEInstance")
    txtSdePassword.Text = GetSetting("ArcView", "ODNR_Geology", "AUMSDEPassword")
    txtSdeVersion.Text = GetSetting("ArcView", "ODNR_Geology", "AUMSDEVersion")
